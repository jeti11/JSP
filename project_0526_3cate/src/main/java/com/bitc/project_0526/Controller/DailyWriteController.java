...
@WebServlet("/blog/dailyWrite.do")
public class DailyWriteController extends HttpServlet {
  @Override
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {

    req.getRequestDispatcher("/view/dailyWrite.jsp").forward(req, resp);
  }
