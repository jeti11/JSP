		...
		<div class="offcanvas offcanvas-start" id="cate">
			...
			<div class="offcanvas-body">
				<ul style="list-style-type: none">
					...
					<li class="my-3 fs-5"><a href="/blog/dailyList.do" class="text-decoration-none text-black">#일상</a></li>
					<li class="my-3 fs-5"><a href="/blog/playList.do" class="text-decoration-none text-black">#플레이리스트</a></li>
				</ul>
