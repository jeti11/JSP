...
public class BoardPlayDAO extends JDBConnect {
  ...
  public List<BoardPlayDTO> selectList(int start, int pageSize) {
    List<BoardPlayDTO> playList = new ArrayList<BoardPlayDTO>();

    String sql = "SELECT * FROM blog_board_play ";
    sql += "ORDER BY idx_play DESC ";
    sql += "LIMIT ?, ? ";
